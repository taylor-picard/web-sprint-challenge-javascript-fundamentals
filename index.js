...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
/* The nested function has access to the internal variable because they are established within the same scope, under (myFunction()).
*/
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(array){
    const result = array.reduce((acc, animal)=>{
...
function CuboidMaker({length, width, height}){
  this.length = {length, width, height}.length;
  this.width = {length, width, height}.width;
  this.height = {length, width, height}.height;
}
